...
We used large language models (LLMs) to accelerate routine coding tasks. Each team member supplied an LLM with a structured brief (data schema, variable descriptions, target definition, leakage constraints, evaluation metrics) to draft boilerplate R code for preprocessing, imputation functions, model scaffolding (keras3), and plotting. To promote diversity of ideas and reduce single-model bias, different teammates intentionally used different LLMs. This use of LLMs sped up drafting, but final code, methodological choices, and validation remained human-curated. Our detailed statement on the use of generative artificial intelligence (AI) is included in [LLM Usage and Reflection](llm-reflection.html). In the next section, we initiated exploratory data analysis (EDA) before developing our model. 
...
![Test data class distribution](../R work/Graphs/fig13.jpg){#fig-Test-data-distribution fig-cap="Test data class distribution"}

<br>
 
Rose Balanced Training Data:

![ROSE Balanced test data class distribution](../R work/Graphs/fig12.jpg){#fig-Test-data-distribution fig-cap="ROSE Balanced test data class distribution"}
...
![Model Accuracy](../R work/Graphs/fig8.jpg){#fig-Model-Accuracy fig-cap="Model Accuracy"}

<br>

The model loss can be seen by:

![Model Loss](../R work/Graphs/fig9.jpg){#fig-Model-Loss fig-cap="Model Loss"}
...
![Prediction Confidence Distribution](../R work/Graphs/fig11.jpg){#fig-Prediction-Confidence-Distribution fig-cap="Prediction Confidence Distribution"}
...
::: {.centered-table}
| Rank | Feature               | Total Score |
|------|-----------------------|-------------|
| 1    | Foot Penetration      | 134.8       |
| 2    | Drift                 | 114.6       |
| 3    | Summit Air Temp       | 106.4       |
| 4    | Total Snow Depth      | 92.0        |
| 5    | Crystals              | 80.6        |
| 6    | Air Temp              | 78.6        |
| 7    | Wind Chill            | 65.5        |
| 8    | Precip Code: None     | 65.2        |
| 9    | Precip Code: Snow     | 64.1        |
| 10   | Snow Index            | 63.6        |
